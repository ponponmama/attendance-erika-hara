                    ...
                    <table class="attendance-detail-table">
                        ...
                        <tr class="attendance-detail-tr">
                            ...
                            <td class="attendance-detail-td">
                                <span class="attendance-detail-text-year">{{ $attendance->date->format('Y年') }}</span>
                                <span class="attendance-detail-text-day">{{ $attendance->date->format('n月j日') }}</span>
                            </td>
                        </tr>
                        <tr class="attendance-detail-tr">
                            ...
                            <td class="attendance-detail-td">
                                ...
                                @else
                                    <span class="attendance-detail-text-time">{{ $attendance->clock_in ? \Carbon\Carbon::parse($attendance->clock_in)->format('H:i') : '' }}</span>
                                @endif
                                <span class="attendance-detail-text-tilde">〜</span>
                                @if ($correctionData && isset($correctionData['clock_out']))
                                    <span class="attendance-detail-text-time">{{ $correctionData['clock_out']['requested'] }}</span>
                                @else
                                    <span class="attendance-detail-text-time">{{ $attendance->clock_out ? \Carbon\Carbon::parse($attendance->clock_out)->format('H:i') : '' }}</span>
                                @endif
                            </td>
                        </tr>
                            ...
                            <tr class="attendance-detail-tr">
                                ...
                                <td class="attendance-detail-td">
                                    @if ($correctionData && isset($correctionData['breaks'][$i]))
                                        <span class="attendance-detail-text-time">{{ $correctionData['breaks'][$i]['break_start']['requested'] }}</span>
                                        <span class="attendance-detail-text-tilde">〜</span>
                                        <span class="attendance-detail-text-time">{{ $correctionData['breaks'][$i]['break_end']['requested'] }}</span>
                                    @else
                                        <span class="attendance-detail-text-time">{{ $break->break_start ? \Carbon\Carbon::parse($break->break_start)->format('H:i') : '' }}</span>
                                        <span class="attendance-detail-text-tilde">〜</span>
                                        <span class="attendance-detail-text-time">{{ $break->break_end ? \Carbon\Carbon::parse($break->break_end)->format('H:i') : '' }}</span>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
                        <tr class="attendance-detail-tr">
                            ...
                            <td class="attendance-detail-td">
                                <span class="attendance-detail-text">{{ $latestRequest->reason ?? $attendance->memo }}</span>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <form class="attendance-detail-form" action="{{ route('stamp_correction_request.store') }}" method="POST">
                ...
                <div class="table-wrapper">
                    <table class="attendance-detail-table">
                        ...
                        <tr class="attendance-detail-tr">
                            <th class="attendance-detail-th">出勤・退勤</th>
                            <td class="attendance-detail-td input-area">
                                @php
                                    $correctionData =
