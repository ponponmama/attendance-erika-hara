...
@section('css')
    <link rel="stylesheet" href="{{ asset('css/users/stamp_correction_list.css') }}">
@endsection
...
@section('content')
    <div class="stamp-correction-list-container">
        ...
        <div class="stamp-correction-list-table-container">
            <table class="stamp-correction-list-table">
                <thead>
